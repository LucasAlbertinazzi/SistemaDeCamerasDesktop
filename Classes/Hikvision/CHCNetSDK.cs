...
namespace SistCamerasGuarita.Classes.Hikvision
{
    public class CHCNetSDK
    {
        ...
        public const int THERMOMETRY_ALARMRULE_NUM = 40; //ÈÈ³ÉÏñ±¨¾¯¹æÔòÊý
        ...
        public const int MAX_CARD_RIGHT_PLAN_NUM = 4;   //¿¨È¨ÏÞ×î´ó¼Æ»®¸öÊý
        public const int MAX_GROUP_NUM_128 = 128; //×î´óÈº×éÊý
        public const int MAX_CARD_READER_NUM = 64;  //×î´ó¶Á¿¨Æ÷Êý
        public const int MAX_SNEAK_PATH_NODE = 8;   //×î´óºóÐø¶Á¿¨Æ÷Êý
        public const int MAX_MULTI_DOOR_INTERLOCK_GROUP = 8;   //×î´ó¶àÃÅ»¥Ëø×éÊý
        public const int MAX_INTER_LOCK_DOOR_NUM = 8;   //Ò»¸ö¶àÃÅ»¥Ëø×éÖÐ×î´ó»¥ËøÃÅÊý
        public const int MAX_CASE_SENSOR_NUM = 8;  //×î´ócase sensor´¥·¢Æ÷Êý
        public const int MAX_DOOR_NUM_256 = 256; //×î´óÃÅÊý
        public const int MAX_READER_ROUTE_NUM = 16;  //×î´óË¢¿¨Ñ­ÐòÂ·¾¶ 
        public const int MAX_FINGER_PRINT_NUM = 10;  //×î´óÖ¸ÎÆ¸öÊý
        public const int MAX_CARD_READER_NUM_512 = 512; //×î´ó¶Á¿¨Æ÷Êý
        public const int NET_SDK_MULTI_CARD_GROUP_NUM_20 = 20;   //µ¥ÃÅ×î´ó¶àÖØ¿¨×éÊý
        public const int CARD_PASSWORD_LEN = 8;   //¿¨ÃÜÂë³¤¶È
        public const int MAX_DOOR_CODE_LEN = 8; //·¿¼ä´úÂë³¤¶È
        public const int MAX_LOCK_CODE_LEN = 8; //Ëø´úÂë³¤¶È

        public const int MAX_NOTICE_NUMBER_LEN = 32;   //¹«¸æ±àºÅ×î´ó³¤¶È
        public const int MAX_NOTICE_THEME_LEN = 64;   //¹«¸æÖ÷Ìâ×î´ó³¤¶È
        public const int MAX_NOTICE_DETAIL_LEN = 1024; //¹«¸æÏêÇé×î´ó³¤¶È
        public const int MAX_NOTICE_PIC_NUM = 6;    //¹«¸æÐÅÏ¢×î´óÍ¼Æ¬ÊýÁ¿
        public const int MAX_DEV_NUMBER_LEN = 32;   //Éè±¸±àºÅ×î´ó³¤¶È
        public const int LOCK_NAME_LEN = 32;  //ËøÃû³Æ

        public const int NET_SDK_EMPLOYEE_NO_LEN = 32;  //¹¤ºÅ³¤¶È
        ...
        public const int SERIAL_NO_LEN = 16;      //²´³µÎ»±àºÅ
        ...
        **************************************************/
        ...
        //Í¼Ïó(NET_DVR_PICCFG_V40½á¹¹)
        public const int NET_DVR_GET_PICCFG_V40 = 6179;//»ñÈ¡Í¼Ïó²ÎÊýV40À©Õ¹
        public const int NET_DVR_SET_PICCFG_V40 = 6180;//ÉèÖÃÍ¼Ïó²ÎÊýV40À©Õ¹
        ...
        public const int NET_DVR_GET_RECORDCFG_V40 = 1008; //»ñÈ¡Â¼Ïñ²ÎÊý(À©Õ¹)
        public const int NET_DVR_SET_RECORDCFG_V40 = 1009; //ÉèÖÃÂ¼Ïñ²ÎÊý(À©Õ¹)
        ...
        //Ô¤ÖÃµãÃû³Æ»ñÈ¡ÓëÉèÖÃ
        public const int NET_DVR_GET_PRESET_NAME = 3383;
        public const int NET_DVR_SET_PRESET_NAME = 3382;

        public const int NET_VCA_GET_RULECFG_V41 = 5011; //»ñÈ¡ÐÐÎª·ÖÎö²ÎÊý
        public const int NET_VCA_SET_RULECFG_V41 = 5012; //ÉèÖÃÐÐÎª·ÖÎö²ÎÊý

        public const int NET_DVR_GET_TRAVERSE_PLANE_DETECTION = 3360; //»ñÈ¡Ô½½çÕì²âÅäÖÃ
        public const int NET_DVR_SET_TRAVERSE_PLANE_DETECTION = 3361; //ÉèÖÃÔ½½çÕì²âÅäÖÃ

        public const int NET_DVR_GET_THERMOMETRY_ALARMRULE = 3627; //»ñÈ¡Ô¤ÖÃµã²âÎÂ±¨¾¯¹æÔòÅäÖÃ
        public const int NET_DVR_SET_THERMOMETRY_ALARMRULE = 3628; //ÉèÖÃÔ¤ÖÃµã²âÎÂ±¨¾¯¹æÔòÅäÖÃ     
        public const int NET_DVR_GET_THERMOMETRY_TRIGGER = 3632; //»ñÈ¡²âÎÂÁª¶¯ÅäÖÃ
        public const int NET_DVR_SET_THERMOMETRY_TRIGGER = 3633; //ÉèÖÃ²âÎÂÁª¶¯ÅäÖÃ

        public const int NET_DVR_SET_MANUALTHERM_BASICPARAM = 6716;  //ÉèÖÃÊÖ¶¯²âÎÂ»ù±¾²ÎÊý
        public const int NET_DVR_GET_MANUALTHERM_BASICPARAM = 6717;  //»ñÈ¡ÊÖ¶¯²âÎÂ»ù±¾²ÎÊý

        public const int NET_DVR_SET_MANUALTHERM = 6708; //ÉèÖÃÊÖ¶¯²âÎÂÊý¾ÝÉèÖÃ

        public const int NET_DVR_GET_MULTI_STREAM_COMPRESSIONCFG = 3216; //Ô¶³Ì»ñÈ¡¶àÂëÁ÷Ñ¹Ëõ²ÎÊý
        public const int NET_DVR_SET_MULTI_STREAM_COMPRESSIONCFG = 3217; //Ô¶³ÌÉèÖÃ¶àÂëÁ÷Ñ¹Ëõ²ÎÊý 

        public const int NET_DVR_VIDEO_CALL_SIGNAL_PROCESS = 16032;  //¿ÉÊÓ»°¶Ô½²ÐÅÁî´¦Àí
        /*************************²ÎÊýÅäÖÃÃüÁî end*******************************/
        ...
        public const int COMM_UPLOAD_VIDEO_INTERCOM_EVENT = 0x1132;  //¿ÉÊÓ¶Ô½²ÊÂ¼þ¼ÇÂ¼ÉÏ´«
        ...
        public const int COMM_ALARM_TPS_REAL_TIME = 0x3081;  //TPSÊµÊ±¹ý³µÊý¾ÝÉÏ´«
        public const int COMM_ALARM_TPS_STATISTICS = 0x3082;  //TPSÍ³¼Æ¹ý³µÊý¾ÝÉÏ´«
        ...
        public const int COMM_UPLOAD_AIOP_VIDEO = 0x4021; //Éè±¸Ö§³ÖAI¿ª·ÅÆ½Ì¨½ÓÈë£¬ÉÏ´«ÊÓÆµ¼ì²âÊý¾Ý
        public const int COMM_UPLOAD_AIOP_PICTURE = 0x4022; //Éè±¸Ö§³ÖAI¿ª·ÅÆ½Ì¨½ÓÈë£¬ÉÏ´«Í¼Æ¬¼ì²âÊý¾Ý
        public const int COMM_UPLOAD_AIOP_POLLING_SNAP = 0x4023; //Éè±¸Ö§³ÖAI¿ª·ÅÆ½Ì¨½ÓÈë£¬ÉÏ´«ÂÖÑ²×¥Í¼Í¼Æ¬¼ì²âÊý¾Ý ¶ÔÓ¦µÄ½á¹¹Ìå(NET_AIOP_POLLING_SNAP_HEAD)
        public const int COMM_UPLOAD_AIOP_POLLING_VIDEO = 0x4024; //Éè±¸Ö§³ÖAI¿ª·ÅÆ½Ì¨½ÓÈë£¬ÉÏ´«ÂÖÑ²ÊÓÆµ¼ì²âÊý¾Ý ¶ÔÓ¦µÄ½á¹¹Ìå(NET_AIOP_POLLING_VIDEO_HEAD)
        ...
        **************************************************/
        ...
        {
            public byte byRed;	 //RGBÑÕÉ«Èý·ÖÁ¿ÖÐµÄºìÉ«
            public byte byGreen; //RGBÑÕÉ«Èý·ÖÁ¿ÖÐµÄÂÌÉ«
            public byte byBlue;	//RGBÑÕÉ«Èý·ÖÁ¿ÖÐµÄÀ¶É«
            public byte byRes;	//±£Áô
        }
        ...
        {
            public NET_DVR_DAYTIME struStartTime; //¿ªÊ¼Ê±¼ä
            public NET_DVR_DAYTIME struStopTime; //½áÊøÊ±¼ä
        }

        [StructLayoutAttribute(LayoutKind.Sequential, CharSet = CharSet.Ansi)]
        public struct NET_DVR_DNMODE
        {
            public byte byObjectSize;//Õ¼±È²ÎÊý(0~100)
            public byte byMotionSensitive; /*ÒÆ¶¯Õì²âÁéÃô¶È, 0 - 5,Ô½¸ßÔ½ÁéÃô,0xff¹Ø±Õ*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public byte byAreaNo;//ÇøÓò±àºÅ(IPC- 1~8)
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
            public NET_VCA_RECT struRect;//µ¥¸öÇøÓòµÄ×ø±êÐÅÏ¢(¾ØÐÎ) size = 16;
            public NET_DVR_DNMODE struDayNightDisable;//¹Ø±ÕÄ£Ê½
            public NET_DVR_DNMODE struDayModeParam;//°×ÌìÄ£Ê½
            public NET_DVR_DNMODE struNightModeParam;//Ò¹ÍíÄ£Ê½
        ...
        {
            public byte byDayNightCtrl;//ÈÕÒ¹¿ØÖÆ 0~¹Ø±Õ,1~×Ô¶¯ÇÐ»»,2~¶¨Ê±ÇÐ»»(Ä¬ÈÏ¹Ø±Õ)
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
            public NET_DVR_SCHEDULE_DAYTIME struScheduleTime;//ÇÐ»»Ê±¼ä  16
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_MULTI_AREA_NUM, ArraySubType = UnmanagedType.Struct)]
            public NET_DVR_MOTION_MULTI_AREAPARAM[] struMotionMultiAreaParam;//×î´óÖ§³Ö24¸öÇøÓò
        ...
        public struct NET_DVR_MOTION_SINGLE_AREA
        {
            ...
            public byte[] byMotionScope;		/*Õì²âÇøÓò,0-96Î»,±íÊ¾64ÐÐ,¹²ÓÐ96*64¸öÐ¡ºê¿é,Ä¿Ç°ÓÐÐ§µÄÊÇ22*18,Îª1±íÊ¾ÊÇÒÆ¶¯Õì²âÇøÓò,0-±íÊ¾²»ÊÇ*/
            public byte byMotionSensitive;			/*ÒÆ¶¯Õì²âÁéÃô¶È, 0 - 5,Ô½¸ßÔ½ÁéÃô,0xff¹Ø±Õ*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public NET_DVR_MOTION_SINGLE_AREA struMotionSingleArea; //ÆÕÍ¨Ä£Ê½ÏÂµÄµ¥ÇøÓòÉè
            public NET_DVR_MOTION_MULTI_AREA struMotionMultiArea; //×¨¼ÒÄ£Ê½ÏÂµÄ¶àÇøÓòÉèÖÃ	
        }
        ...
        {
            public NET_DVR_MOTION_MODE_PARAM struMotionMode; //(5.1.0ÐÂÔö)
            public byte byEnableHandleMotion;       /* ÊÇ·ñ´¦ÀíÒÆ¶¯Õì²â 0£­·ñ 1£­ÊÇ*/
            public byte byEnableDisplay;	/*ÆôÓÃÒÆ¶¯Õì²â¸ßÁÁÏÔÊ¾£¬0-·ñ£¬1-ÊÇ*/
            public byte byConfigurationMode; //0~ÆÕÍ¨,1~×¨¼Ò(5.1.0ÐÂÔö)
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMOUT_V40, ArraySubType = UnmanagedType.U4)]
            public uint[] dwRelAlarmOut; //Êµ¼Ê´¥·¢µÄ±¨¾¯Êä³öºÅ£¬°´Öµ±íÊ¾,²ÉÓÃ½ô´ÕÐÍÅÅÁÐ£¬´ÓÏÂ±ê0 - dwRelAlarmOut -1ÓÐÐ§£¬Èç¹ûÖÐ¼äÓöµ½0xffffffff,ÔòºóÐøÎÞÐ§
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
            public NET_DVR_SCHEDTIME[] struAlarmTime; /*²¼·ÀÊ±¼ä*/
            /*´¥·¢µÄÂ¼ÏñÍ¨µÀ*/
            public uint dwMaxRecordChanNum;   //Éè±¸Ö§³ÖµÄ×î´ó¹ØÁªÂ¼ÏñÍ¨µÀÊý-Ö»¶Á
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_CHANNUM_V40, ArraySubType = UnmanagedType.U4)]
            public uint[] dwRelRecordChan;   /* Êµ¼Ê´¥·¢Â¼ÏñÍ¨µÀ£¬°´Öµ±íÊ¾,²ÉÓÃ½ô´ÕÐÍÅÅÁÐ£¬´ÓÏÂ±ê0 - dwRelRecordChan -1ÓÐÐ§£¬Èç¹ûÖÐ¼äÓöµ½0xffffffff,ÔòºóÐøÎÞÐ§*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
        ...
        public struct NET_DVR_HIDEALARM_V40
        {
            ...
            public uint dwMaxRelAlarmOutChanNum; //´¥·¢µÄ±¨¾¯Êä³öÍ¨µÀÊý£¨Ö»¶Á£©×î´óÖ§³ÖÊýÁ¿
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALARMOUT_V40, ArraySubType = UnmanagedType.U4)]
            public uint[] dwRelAlarmOut; /*´¥·¢±¨¾¯Êä³öºÅ£¬°´Öµ±íÊ¾,²ÉÓÃ½ô´ÕÐÍÅÅÁÐ£¬´ÓÏÂ±ê0 - dwRelAlarmOut -1ÓÐÐ§£¬Èç¹ûÖÐ¼äÓöµ½0xffffffff,ÔòºóÐøÎÞÐ§*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
            public NET_DVR_SCHEDTIME[] struAlarmTime; /*²¼·ÀÊ±¼ä*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes; //±£Áô
        ...
        {
            public uint dwEnableVILostAlarm;                /* ÊÇ·ñÆô¶¯ÐÅºÅ¶ªÊ§±¨¾¯ ,0-·ñ,1-ÊÇ*/
            /* ÐÅºÅ¶ªÊ§´¥·¢±¨¾¯Êä³ö */
            public uint dwHandleType;        //Òì³£´¦Àí,Òì³£´¦Àí·½Ê½µÄ"»ò"½á¹û     
            /*0x00: ÎÞÏìÓ¦*/
            /*0x01: ¼àÊÓÆ÷ÉÏ¾¯¸æ*/
        ...
        public struct NET_DVR_VICOLOR
        {
            ...
            public NET_DVR_COLOR[] struColor;/*Í¼Ïó²ÎÊý(µÚÒ»¸öÓÐÐ§£¬ÆäËûÈý¸ö±£Áô)*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
            public NET_DVR_SCHEDTIME[] struHandleTime;/*´¦ÀíÊ±¼ä¶Î(±£Áô)*/
        }
        ...
        public struct NET_DVR_PICCFG_V40
        {
            ...
            public NET_DVR_VICOLOR struViColor;//	Í¼Ïñ²ÎÊý°´Ê±¼ä¶ÎÉèÖÃ
                                               //ÏÔÊ¾Í¨µÀÃû
            public uint dwShowChanName; // Ô¤ÀÀµÄÍ¼ÏóÉÏÊÇ·ñÏÔÊ¾Í¨µÀÃû³Æ,0-²»ÏÔÊ¾,1-ÏÔÊ¾
            ...
            //OSD
            public uint dwShowOsd;// Ô¤ÀÀµÄÍ¼ÏóÉÏÊÇ·ñÏÔÊ¾OSD,0-²»ÏÔÊ¾,1-ÏÔÊ¾
            ...
            public byte byFontSize;      //16*16(ÖÐ)/8*16(Ó¢)£¬1-32*32(ÖÐ)/16*32(Ó¢)£¬2-64*64(ÖÐ)/32*64(Ó¢) FOR 91ÏµÁÐHD-SDI¸ßÇåDVR
            public byte byOSDColorType;	 //0-Ä¬ÈÏ£¨ºÚ°×£©£»1-×Ô¶¨Òå
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            public NET_DVR_VILOST_V40 struVILost;  //ÊÓÆµÐÅºÅ¶ªÊ§±¨¾¯£¨Ö§³Ö×é£©
            public NET_DVR_VILOST_V40 struAULost;  /*ÒôÆµÐÅºÅ¶ªÊ§±¨¾¯£¨Ö§³Ö×é£©*/
            public NET_DVR_MOTION_V40 struMotion;  //ÒÆ¶¯Õì²â±¨¾¯£¨Ö§³Ö×é£©
            public NET_DVR_HIDEALARM_V40 struHideAlarm;  //ÕÚµ²±¨¾¯£¨Ö§³Ö×é£©
            public NET_DVR_RGB_COLOR struOsdColor;//OSDÑÕÉ«
        ...
        public struct NET_DVR_MULTI_STREAM_COMPRESSIONCFG_COND
        {
            ...
            public uint dwStreamType; //ÂëÁ÷ÀàÐÍ£¬0-Ö÷ÂëÁ÷£¬1-×ÓÂëÁ÷£¬2-ÊÂ¼þÀàÐÍ£¬3-ÂëÁ÷3£¬¡­¡­£¨×Ô¶¨ÒåÂëÁ÷ÀàÐÍÐèÍ¨¹ýGET /ISAPI/Streaming/channels/<ID>/customStream»ñÈ¡µ±Ç°Í¨µÀÒÑ¾­Ìí¼ÓµÄËùÓÐ×Ô¶¨ÒåÂëÁ÷ID¡£×Ô¶¨ÒåÂëÁ÷Îª6~10£¬ÆäË÷ÒýÖµ¾ÍÊÇ6~10£©
        ...
        {
            public uint dwSize;
            public uint dwStreamType;        //ÂëÁ÷ÀàÐÍ£¬0-Ö÷ÂëÁ÷£¬1-×ÓÂëÁ÷£¬2-ÊÂ¼þÀàÐÍ£¬3-ÂëÁ÷3£¬¡­¡­
            public NET_DVR_COMPRESSION_INFO_V30 struStreamPara;        //ÂëÁ÷Ñ¹Ëõ²ÎÊý
        ...
        public struct NET_DVR_RECORDSCHED_V40
        {
            ...
            35-´¬Ö»¼ì²â, 36-²âÎÂÔ¤¾¯£¬37-²âÎÂ±¨¾¯£¬38-ÎÂ²î±¨¾¯£¬39-ÀëÏß²âÎÂ±¨¾¯,40-·ÀÇø±¨¾¯£¬41-½ô¼±ÇóÖú,42-ÒµÎñ×ÉÑ¯,43-ÆðÉí¼ì²â,44-ÕÛÏßÅÊ¸ß,45-Èç²Þ³¬Ê±£¬46-ÈËÁ³×¥ÅÄ£¬47-·Ç·¨°ÚÌ¯,48-Ä¿±ê×¥ÅÄ,
            49-¾çÁÒÔË¶¯£¬50Àë¸Ú¼ì²â£¬51-ÆðÁ¢£¬52ÈËÊý±ä»¯ */
        ...
        {
            public byte byAllDayRecord; /* ÊÇ·ñÈ«ÌìÂ¼Ïñ 0-·ñ 1-ÊÇ*/
            /*Â¼ÏñÀàÐÍ£¬0:¶¨Ê±Â¼Ïñ£¬1:ÒÆ¶¯Õì²â£¬2:±¨¾¯Â¼Ïñ£¬3:¶¯²â|±¨¾¯£¬4:¶¯²â&±¨¾¯ 5:ÃüÁî´¥·¢, 
            6-ÖÇÄÜ±¨¾¯Â¼Ïñ£¬10-PIR±¨¾¯£¬11-ÎÞÏß±¨¾¯£¬12-ºô¾È±¨¾¯£¬13-È«²¿ÊÂ¼þ,14-ÖÇÄÜ½»Í¨ÊÂ¼þ, 
            15-Ô½½çÕì²â,16-ÇøÓòÈëÇÖ,17-ÉùÒôÒì³£,18-³¡¾°±ä¸üÕì²â,
            19-ÖÇÄÜÕì²â(Ô½½çÕì²â|ÇøÓòÈëÇÖ|ÈËÁ³Õì²â|ÉùÒôÒì³£|³¡¾°±ä¸üÕì²â),20£­ÈËÁ³Õì²â,21-POSÂ¼Ïñ,
        ...
        public struct NET_DVR_RECORD_V40
        {
            ...
            public uint dwRecordTime;                    /* Â¼ÏóÑÓÊ±³¤¶È 0-5Ãë£¬ 1-10Ãë£¬ 2-30Ãë£¬ 3-1·ÖÖÓ£¬ 4-2·ÖÖÓ£¬ 5-5·ÖÖÓ£¬ 6-10·ÖÖÓ*/
            ...
            public byte byStreamType;  // 0-Ö÷ÂëÁ÷£¬1-×ÓÂëÁ÷£¬2-Ö÷×ÓÂëÁ÷Í¬Ê± 3-ÈýÂëÁ÷
            ...
            public byte byRecordManage;   //Â¼Ïñµ÷¶È£¬0-ÆôÓÃ£¬ 1-²»ÆôÓÃ; ÆôÓÃÊ±½øÐÐ¶¨Ê±Â¼Ïñ£»²»ÆôÓÃÊ±²»½øÐÐ¶¨Ê±Â¼Ïñ£¬µ«ÊÇÂ¼Ïñ¼Æ»®ÈÔÔÚÊ¹ÓÃ£¬±ÈÈçÒÆ¶¯Õì²â£¬»Ø´«¶¼»¹ÔÚ°´ÕâÌõÂ¼Ïñ¼Æ»®½øÐÐ
            public byte byExtraSaveAudio;//ÒôÆµµ¥¶À´æ´¢
            /*¿ªÆôÖÇÄÜÂ¼Ïñ¹¦ÄÜºó£¬Ëã·¨¿âÊÇ×Ô¶¯ÆôÓÃÖÇÄÜÂ¼ÏñËã·¨£¬Æä¹¦ÄÜÎªÈôÂ¼ÏñÖÐÎÞÄ¿±ê³öÏÖ£¬»á½µµÍÂëÂÊ¡¢Ö¡ÂÊ£¬¶øÄ¿±ê³öÏÖÊ±ÓÖ»Ö¸´È«ÂëÂÊ¼°Ö¡ÂÊ£¬´Ó¶ø´ïµ½¼õÉÙ×ÊÔ´ÏûºÄµÄÄ¿µÄ*/
            public byte byIntelligentRecord;//ÊÇ·ñ¿ªÆôÖÇÄÜÂ¼Ïñ¹¦ÄÜ 0-·ñ 1-ÊÇ
        ...
        public struct NET_DVR_DEVICEINFO_V40
        {
            ...
            public byte bySupportLock;        //Éè±¸Ö§³ÖËø¶¨¹¦ÄÜ£¬¸Ã×Ö¶ÎÓÉSDK¸ù¾ÝÉè±¸·µ»ØÖµÀ´¸³ÖµµÄ¡£bySupportLockÎª1Ê±£¬dwSurplusLockTimeºÍbyRetryLoginTimeÓÐÐ§
            public byte byRetryLoginTime;	    //Ê£Óà¿É³¢ÊÔµÇÂ½µÄ´ÎÊý£¬ÓÃ»§Ãû£¬ÃÜÂë´íÎóÊ±£¬´Ë²ÎÊýÓÐÐ§
            public byte byPasswordLevel;      //adminÃÜÂë°²È«µÈ¼¶0-ÎÞÐ§£¬1-Ä¬ÈÏÃÜÂë£¬2-ÓÐÐ§ÃÜÂë,3-·çÏÕ½Ï¸ßµÄÃÜÂë¡£µ±ÓÃ»§µÄÃÜÂëÎª³ö³§Ä¬ÈÏÃÜÂë£¨12345£©»òÕß·çÏÕ½Ï¸ßµÄÃÜÂëÊ±£¬ÉÏ²ã¿Í»§¶ËÐèÒªÌáÊ¾ÓÃ»§¸ü¸ÄÃÜÂë¡£      
            public byte byProxyType;//´úÀíÀàÐÍ£¬0-²»Ê¹ÓÃ´úÀí, 1-Ê¹ÓÃsocks5´úÀí, 2-Ê¹ÓÃEHome´úÀí
            public uint dwSurplusLockTime;	//Ê£ÓàÊ±¼ä£¬µ¥Î»Ãë£¬ÓÃ»§Ëø¶¨Ê±£¬´Ë²ÎÊýÓÐÐ§
            public byte byCharEncodeType;     //×Ö·û±àÂëÀàÐÍ
            public byte bySupportDev5;//Ö§³Öv50°æ±¾µÄÉè±¸²ÎÊý»ñÈ¡£¬Éè±¸Ãû³ÆºÍÉè±¸ÀàÐÍÃû³Æ³¤¶ÈÀ©Õ¹Îª64×Ö½Ú
            public byte bySupport;  //ÄÜÁ¦¼¯À©Õ¹£¬Î»Óë½á¹û£º0- ²»Ö§³Ö£¬1- Ö§³Ö
            // bySupport & 0x1:  ±£Áô
            // bySupport & 0x2:  0-²»Ö§³Ö±ä»¯ÉÏ±¨ 1-Ö§³Ö±ä»¯ÉÏ±¨
            public byte byLoginMode; //µÇÂ¼Ä£Ê½ 0-PrivateµÇÂ¼ 1-ISAPIµÇÂ¼
            public int dwOEMCode;
            public int iResidualValidity;   //¸ÃÓÃ»§ÃÜÂëÊ£ÓàÓÐÐ§ÌìÊý£¬µ¥Î»£ºÌì£¬·µ»Ø¸ºÖµ£¬±íÊ¾ÃÜÂëÒÑ¾­³¬ÆÚÊ¹ÓÃ£¬ÀýÈç¡°-3±íÊ¾ÃÜÂëÒÑ¾­³¬ÆÚÊ¹ÓÃ3Ìì¡±
            public byte byResidualValidity; // iResidualValidity×Ö¶ÎÊÇ·ñÓÐÐ§£¬0-ÎÞÐ§£¬1-ÓÐÐ§
        ...
        public struct NET_DVR_USER_LOGIN_INFO
        {
            ...
            public byte byProxyType; //0:²»Ê¹ÓÃ´úÀí£¬1£ºÊ¹ÓÃ±ê×¼´úÀí£¬2£ºÊ¹ÓÃEHome´úÀí
            public byte byUseUTCTime;    //0-²»½øÐÐ×ª»»£¬Ä¬ÈÏ,1-½Ó¿ÚÉÏÊäÈëÊä³öÈ«²¿Ê¹ÓÃUTCÊ±¼ä,SDKÍê³ÉUTCÊ±¼äÓëÉè±¸Ê±ÇøµÄ×ª»»,2-½Ó¿ÚÉÏÊäÈëÊä³öÈ«²¿Ê¹ÓÃÆ½Ì¨±¾µØÊ±¼ä£¬SDKÍê³ÉÆ½Ì¨±¾µØÊ±¼äÓëÉè±¸Ê±ÇøµÄ×ª»»
            public byte byLoginMode; //0-Private, 1-ISAPI, 2-×ÔÊÊÓ¦
            public byte byHttps;    //0-²»ÊÊÓÃtls£¬1-Ê¹ÓÃtls 2-×ÔÊÊÓ¦
            public int iProxyID;    //´úÀí·þÎñÆ÷ÐòºÅ£¬Ìí¼Ó´úÀí·þÎñÆ÷ÐÅÏ¢Ê±£¬Ïà¶ÔÓ¦µÄ·þÎñÆ÷Êý×éÏÂ±íÖµ
            public byte byVerifyMode;  //ÈÏÖ¤·½Ê½£¬0-²»ÈÏÖ¤£¬1-Ë«ÏòÈÏÖ¤£¬2-µ¥ÏòÈÏÖ¤£»ÈÏÖ¤½öÔÚÊ¹ÓÃTLSµÄÊ±ºòÉúÐ§;    
        ...
        public struct NET_DVR_ALARMER
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sDeviceName;/* Éè±¸Ãû×Ö */
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MACADDR_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byMacAddr;/* MACµØÖ· */
            public ushort wLinkPort; /* link port */
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
            public byte[] sDeviceIP;/* IPµØÖ· */
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
            public byte[] sSocketIP;/* ±¨¾¯Ö÷¶¯ÉÏ´«Ê±µÄsocket IPµØÖ· */
        ...
        public struct NET_VCA_TRAVERSE_PLANE
        {
            ...
            public uint dwCrossDirection;//´©Ô½·½Ïò: 0-Ë«Ïò£¬1-´Ó×óµ½ÓÒ£¬2-´ÓÓÒµ½×ó
            public byte bySensitivity;//ÁéÃô¶È£¬È¡Öµ·¶Î§£º[1,5] £¨¶ÔÓÚSmart IPC£¬È¡Öµ·¶Î§Îª[1,100]£© 
        ...
        public struct NET_VCA_ONE_RULE_V41
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byRuleName; //¹æÔòÃû³Æ
            public uint dwEventType;	//ÐÐÎªÊÂ¼þÀàÐÍ£¬±£ÁôÊÇÎªÁË¼æÈÝ£¬ºóÐø½¨ÒéÊ¹ÓÃwEventTypeEx»ñÈ¡ÊÂ¼þÀàÐÍ
            public NET_VCA_EVENT_UNION uEventParam; //ÐÐÎª·ÖÎöÊÂ¼þ²ÎÊý
            public NET_VCA_SIZE_FILTER struSizeFilter;  //³ß´ç¹ýÂËÆ÷
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
            public NET_DVR_SCHEDTIME[] struAlarmTime;//²¼·ÀÊ±¼ä
        ...
        public struct NET_VCA_DEV_INFO
        {
            ...
            public byte byIvmsChannel;// ±£Áô×Ö½Ú
        }
        ...
        public struct NET_VCA_RULE_ALARM
        {
            ...
            public byte byRelativeTimeFlag;      //dwRelativeTime×Ö¶ÎÊÇ·ñÓÐÐ§  0-ÎÞÐ§£¬ 1-ÓÐÐ§£¬dwRelativeTime±íÊ¾UTCÊ±¼ä 
            public byte byAppendInfoUploadEnabled; //¸½¼ÓÐÅÏ¢ÉÏ´«Ê¹ÄÜ 0-²»ÉÏ´« 1-ÉÏ´«
            public IntPtr pAppendInfo;     //Ö¸Ïò¸½¼ÓÐÅÏ¢NET_VCA_APPEND_INFOµÄÖ¸Õë£¬byAppendInfoUploadEnabledÎª1Ê±»òÕßbyTimeDiffFlagÎª1Ê±ÓÐÐ§
        ...
        public struct NET_DVR_SYSTEM_TIME
        {
            ...
            public ushort wMonth;          //ÔÂ
            public ushort wDay;            //ÈÕ
            public ushort wHour;           //Ê±
            public ushort wMinute;      //·Ö
            public ushort wSecond;      //Ãë
            public ushort wMilliSec;    //ºÁÃë
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }

        //Éè±¸Ö§³ÖAI¿ª·ÅÆ½Ì¨½ÓÈë£¬ÉÏ´«ÊÓÆµ¼ì²âÊý¾Ý
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_AIOP_VIDEO_HEAD
        {
            public uint dwSize;      //dwSize = sizeof(NET_AIOP_VIDEO_HEAD)
            public uint dwChannel;    //Éè±¸·ÖÎöÍ¨µÀµÄÍ¨µÀºÅ£»
            public NET_DVR_SYSTEM_TIME struTime; 	//Ê±¼ä
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] szTaskID;     //ÊÓÆµÈÎÎñID£¬À´×ÔÓÚÊÓÆµÈÎÎñÅÉ·¢
            public uint dwAIOPDataSize;   //¶ÔÓ¦AIOPDdataÊý¾Ý³¤¶È
            public uint dwPictureSize;    //¶ÔÓ¦·ÖÎöÍ¼Æ¬³¤¶È
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] szMPID;        //¼ì²âÄ£ÐÍ°üID£¬ÓÃÓÚÆ¥ÅäAIOPµÄ¼ì²âÊý¾Ý½âÎö£»¿ÉÒÔÍ¨¹ýURI(GET /ISAPI/Intelligent/AIOpenPlatform/algorithmModel/management?format=json)»ñÈ¡µ±Ç°Éè±¸¼ÓÔØµÄÄ£ÐÍ°üµÄlabel descriptionÐÅÏ¢£»
            public IntPtr pBufferAIOPData;  //AIOPDdataÊý¾Ý
            public IntPtr pBufferPicture;//¶ÔÓ¦·ÖÎöÍ¼Æ¬Êý¾Ý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 184, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }

        //Éè±¸Ö§³ÖAI¿ª·ÅÆ½Ì¨½ÓÈë£¬ÉÏ´«Í¼Æ¬¼ì²âÊý¾Ý
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_AIOP_PICTURE_HEAD
        {
            ...
            public NET_DVR_SYSTEM_TIME struTime; 	//Ê±¼ä
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] szPID;        //Í¸´«ÏÂ·¢µÄÍ¼Æ¬ID£¬À´×ÔÓÚÍ¼Æ¬ÈÎÎñÅÉ·¢
            public uint dwAIOPDataSize;   //¶ÔÓ¦AIOPDdataÊý¾Ý³¤¶È
            public byte byStatus;         //×´Ì¬Öµ£º0-³É¹¦£¬1-Í¼Æ¬´óÐ¡´íÎó
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] szMPID; //¼ì²âÄ£ÐÍ°üID£¬ÓÃÓÚÆ¥ÅäAIOPµÄ¼ì²âÊý¾Ý½âÎö£»
            public IntPtr pBufferAIOPData;//AIOPDdataÊý¾Ý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 184, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        public struct NET_AIOP_POLLING_VIDEO_HEAD
        {
            ...
            public uint dwChannel;      //Éè±¸·ÖÎöÍ¨µÀµÄÍ¨µÀºÅ(×ßSDKÐ­Òé)£»
            public NET_DVR_SYSTEM_TIME struTime; 	//Ê±¼ä
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] szTaskID;    //ÂÖÑ¯×¥Í¼ÈÎÎñID£¬À´×ÔÓÚÂÖÑ¯×¥Í¼ÈÎÎñÅÉ·¢
            public uint dwAIOPDataSize;	//¶ÔÓ¦AIOPDdataÊý¾Ý³¤¶È
            public uint dwPictureSize;	//¶ÔÓ¦·ÖÎöÍ¼Æ¬³¤¶È
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] szMPID; //¼ì²âÄ£ÐÍ°üID£¬ÓÃÓÚÆ¥ÅäAIOPµÄ¼ì²âÊý¾Ý½âÎö£»
        ...
        public struct NET_AIOP_POLLING_SNAP_HEAD
        {
            ...
            public byte[] szMPID;       //¼ì²âÄ£ÐÍ°üID£¬ÓÃÓÚÆ¥ÅäAIOPµÄ¼ì²âÊý¾Ý½âÎö£»
            public IntPtr pBufferAIOPData;//AIOPDdataÊý¾Ý
            public IntPtr pBufferPicture;//·ÖÎöÍ¼Æ¬Êý¾Ý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 184, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public byte byStart;          // ¿ªÊ¼Âë
            public byte byCMD;         // ÃüÁîºÅ£¬01-½øÈëÖ¸Áî£¬02-Àë¿ªÖ¸Áî£¬03-Óµ¶Â×´Ì¬Ö¸Áî(Îª03Ê±£¬Ö»ÓÐbyLaneStateºÍbyQueueLenÓÐÐ§)£¬04-¶àÏßÈ¦×´Ì¬£¨Îª04Ê±£¬wLoopStateºÍwStateMaskÓÐÐ§£¬±íÊ¾byLane³µµÀÉÏ¶à¸öÏßÈ¦µÄ¹ý³µ×´Ì¬£©
            public ushort wSpaceHeadway;        //³µÍ·¼ä¾à£¬ÒÔÃ×À´¼ÆËã
            public ushort wDeviceID;      // Éè±¸ID
            public ushort wDataLen;       // Êý¾Ý³¤¶È
            public byte byLane;         // ¶ÔÓ¦³µµÀºÅ
            public byte bySpeed;        // ¶ÔÓ¦³µËÙ£¨KM/H£©
            public byte byLaneState;     // ³µµÀ×´Ì¬£»0-ÎÞ×´Ì¬£¬1-³©Í¨£¬2-Óµ¼·£¬3-¶ÂÈû
            public byte byQueueLen;       // ¶ÂÈû×´Ì¬ÏÂÅÅ¶Ó³¤¶È£¨±ÈÈç50Ã×£©
            public ushort wLoopState;         //ÏßÈ¦×´Ì¬£¬µÚ¼¸Î»±íÊ¾¼¸ºÅÏßÈ¦×´Ì¬£¬ÏßÈ¦±àºÅ´Ó¾µÍ·ÓÉ½üµ½Ô¶ÒÀ´ÎÔö´ó¡£×´Ì¬1-µ½´ï£¬0-Àë¿ª
            public ushort wStateMask;         //ÏßÈ¦×´Ì¬ÑÚÂë£¬ÑÚÂëÎ»Îª1¶ÔÓ¦wLoopState×´Ì¬Î»ÓÐÐ§£¬Îª0±íÊ¾ÎÞÐ§
            public uint dwDownwardFlow;     //µ±Ç°³µµÀ ´ÓÉÏµ½ÏÂ³µÁ÷Á¿
            public uint dwUpwardFlow;       //µ±Ç°³µµÀ ´ÓÏÂµ½ÉÏ³µÁ÷Á¿
            public byte byJamLevel;         //Óµ¶ÂµÈ¼¶£¬µ±byLaneStateÎª3Ê±ÓÐÐ§£¬1-Çá¶È£¬2-ÖÐ¶È£¬3-ÖØ¶È
            public byte byVehicleDirection; //0-Î´Öª£¬1-ÓÉÉÏ¶øÏÂ£¬2-ÓÉÏÂ¶øÉÏ
            public byte byJamFlow;          //Óµ¶ÂÐÂÔöÁ÷Á¿£¬Ã¿ÐÂÔöÒ»Á¾³µ¾ÍÉÏ±¨Ò»´ÎÀÛ¼Æ³µÁ¾µÄÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 7, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;        //±£Áô
            public ushort wTimeHeadway;        // ³µÍ·Ê±¾à£¬ÒÔÃë¼ÆËã
        }

        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_LLI_PARAM
        {
            public float fSec;//Ãë[0.000000,60.000000]
            public byte byDegree;//¶È:Î³¶È[0,90] ¾­¶È[0,180]
            public byte byMinute;//·Ö[0,59]
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public byte byLatitudeType;//Î³¶ÈÀàÐÍ£¬0-±±Î³£¬1-ÄÏÎ³
            public byte byLongitudeType;//¾­¶ÈÀàÐÍ£¬0-¶«¾­£¬1-Î÷¾­
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            public NET_DVR_LLI_PARAM struLatitude;    /*Î³¶È*/
            public NET_DVR_LLI_PARAM struLongitude; /*¾­¶È*/
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public NET_DVR_LLPOS_PARAM struLLPos;//³µÁ÷Á¿×îºóÒ»Á¾³µµÄ¾­Î³¶ÈÎ»ÖÃÐÅÏ¢(byLaneState=3ÇÒbyQueueLen>0Ê±²Å·µ»Ø)
        ...
        {
            public uint dwSize;          // ½á¹¹Ìå´óÐ¡
            public uint dwChan;//Í¨µÀºÅ
            public NET_DVR_TIME_V30 struTime;    //¼ì²âÊ±¼ä
            public NET_DVR_TPS_PARAM struTPSRealTimeInfo;// ½»Í¨²ÎÊýÍ³¼ÆÐÅÏ¢
            public IntPtr pAddInfoBuffer;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
            /*¸½¼ÓÐÅÏ¢±êÊ¶£¨¼´ÊÇ·ñÓÐNET_DVR_TPS_ADDINFO½á¹¹Ìå£©,0-ÎÞ¸½¼ÓÐÅÏ¢, 1-ÓÐ¸½¼ÓÐÅÏ¢¡£*/
        ...
        {
            public byte byLane;             // ¶ÔÓ¦³µµÀºÅ
            public byte bySpeed;             // ³µµÀ¹ý³µÆ½¾ùËÙ¶È
            public ushort wArrivalFlow;        //µ½´ïÁ÷Á¿
            ...
            public float fSpaceOccupyRation; // ¿Õ¼äÕ¼ÓÐÂÊ£¬°Ù·Ö±È¼ÆËã,¸¡µãÊý*1000
            public float fTimeOccupyRation;  // Ê±¼äÕ¼ÓÐÂÊ£¬°Ù·Ö±È¼ÆËã,¸¡µãÊý*1000
            public byte byStoppingTimes; //Æ½¾ùÍ£³µ´ÎÊý
            public byte byQueueLen;       // ¶ÂÈû×´Ì¬ÏÂÅÅ¶Ó³¤¶È£¨±ÈÈç50Ã×£©
            public byte byFlag;          //ÉÏ´«±êÊ¶£¬0-±íÊ¾T1Ê±¼äµÄÍ³¼Æ½á¹û,1-±íÊ¾T2Ê±¼äµÄÍ³¼Æ
            public byte byVehicelNum;         //ÇøÓò³µÁ¾Êý
            public ushort wDelay;         //Æ½¾ùÑÓÎó
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;               // ±£Áô
            public uint dwNonMotor;      // ·Ç»ú¶¯³µÊýÁ¿
        }
        ...
        {
            public byte byStart;          // ¿ªÊ¼Âë
            public byte byCMD;         // ÃüÁîºÅ£¬ 08-¶¨Ê±³É×éÊý¾ÝÖ¸Áî
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;        // Ô¤Áô×Ö½Ú
            public ushort wDeviceID;      // Éè±¸ID
            public ushort wDataLen;       // Êý¾Ý³¤¶È
            public byte byTotalLaneNum;  // ÓÐÐ§³µµÀ×ÜÊý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 15, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            public NET_DVR_TIME_V30 struStartTime;    //Í³¼Æ¿ªÊ¼Ê±¼ä
            public uint dwSamplePeriod;    //Í³¼ÆÊ±¼ä,µ¥Î»Ãë
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TPS_RULE, ArraySubType = UnmanagedType.Struct)]
        ...
        public struct NET_DVR_TPS_STATISTICS_INFO
        {
            public uint dwSize;          // ½á¹¹Ìå´óÐ¡
            public uint dwChan;//Í¨µÀºÅ
            public NET_DVR_TPS_STATISTICS_PARAM struTPSStatisticsInfo;// ½»Í¨²ÎÊýÍ³¼ÆÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 128, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;      // ±£Áô
        }
        ...
        public struct NET_DVR_AID_INFO
        {
            ...
            public byte byVehicleEnterState;//³µÁ¾³öÈë×´Ì¬ 0-ÎÞÐ§ 1-Ê»Èë 2-Ê»³ö
            public byte byState; //0-±ä»¯ÉÏ´«£¬1-ÂÖÑ²ÉÏ´«
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
            public byte[] byParkingID; //Í£³µÎ»±àºÅ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;  // ±£Áô×Ö½Ú 
        }
        ...
        public struct NET_DVR_AID_ALARM_V41
        {
            ...
            public byte byLaneNo;  //¹ØÁª³µµÀºÅ 
            public ushort wMilliSecond;        //Ê±±êºÁÃë
            ...
            public IntPtr pXmlBuf;// XML±¨¾¯ÐÅÏ¢Ö¸Õë,ÆäXML¶ÔÓ¦µ½EventNotificationAlert XML Block
            public byte byTargetType;// ¼ì²âµÄÄ¿±êÀàÐÍ£¬0~Î´Öª£¬1~ÐÐÈË¡¢2~¶þÂÖ³µ¡¢3~ÈýÂÖ³µ(ÐÐÈË¼ì²âÖÐ·µ»Ø)
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 19, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes; // ±£Áô×Ö½Ú   
        }
        ...
        public struct NET_DVR_VEHICLE_INFO
        {
            ...
            public byte byVehicleSubLogoRecog; //³µÁ¾Æ·ÅÆ×ÓÀàÐÍÊ¶±ð£»²Î¿¼VSB_VOLKSWAGEN_CLASSµÈ×ÓÀàÐÍÃ¶¾Ù¡£
            public byte byVehicleModel; //³µÁ¾×ÓÆ·ÅÆÄê¿î£¬0-Î´Öª£¬²Î¿¼"³µÁ¾×ÓÆ·ÅÆÄê¿î.xlsx"
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
            public byte[] byCustomInfo;  //×Ô¶¨ÒåÐÅÏ¢
            public ushort wVehicleLogoRecog;  //³µÁ¾Ö÷Æ·ÅÆ£¬²Î¿¼"³µÁ¾Ö÷Æ·ÅÆ.xlsx" (¸Ã×Ö¶Î¼æÈÝbyVehicleLogoRecog);
            public byte byIsParking;//ÊÇ·ñÍ£³µ 0-ÎÞÐ§£¬1-Í£³µ£¬2-Î´Í£³µ
            public byte byRes;//±£Áô×Ö½Ú
            public uint dwParkingTime; //Í£³µÊ±¼ä£¬µ¥Î»£ºs
            public byte byBelieve; //byIllegalTypeÖÃÐÅ¶È£¬1-100
            public byte byCurrentWorkerNumber;//µ±Ç°×÷ÒµÈËÊý
            public byte byCurrentGoodsLoadingRate;//µ±Ç°»õÎï×°ÔØÂÊ 0-¿Õ 1-ÉÙ 2-ÖÐ 3-¶à 4-Âú
            public byte byDoorsStatus;//³µÃÅ×´Ì¬ 0-³µÃÅ¹Ø±Õ 1-³µÃÅ¿ªÆô
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes3;
        ...
        public struct NET_DVR_IPC_PROTO_LIST_V41
        {
            public uint dwSize;
            public uint dwProtoNum;  //ÓÐÐ§µÄipcÐ­ÒéÊýÄ¿
            public IntPtr pBuffer;    //Ð­ÒéÁÐ±í»º³åÇø, dwProtoNum ¸öNET_DVR_PROTO_TYPE½á¹¹  
            public uint dwBufferLen; //»º³åÇø³¤¶È
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public uint dwSize;
            public uint dwCmdType;      //ÐÅÁîÀàÐÍ  0-ÇëÇóºô½Ð£¬1-È¡Ïû±¾´Îºô½Ð£¬2-½ÓÌý±¾´Îºô½Ð 3-¾Ü¾ø±¾µØÀ´µçºô½Ð 4-±»½ÐÏìÁå³¬Ê± 5-½áÊø±¾´ÎÍ¨»°£¬6-Éè±¸ÕýÔÚÍ¨»°ÖÐ£¬7-¿Í»§¶ËÕýÔÚÍ¨»°ÖÐ£¬8ÊÒÄÚ»ú²»ÔÚÏß
            public ushort wPeriod;  //ÆÚºÅ, ·¶Î§[0,9]
            public ushort wBuildingNumber; //Â¥ºÅ
            public ushort wUnitNumber;  //µ¥ÔªºÅ
            public ushort wFloorNumber;  //²ãºÅ
            public ushort wRoomNumber;    //·¿¼äºÅ
            public ushort wDevIndex; //Éè±¸±àºÅ
            public byte byUnitType; //Éè±¸ÀàÐÍ£¬1-ÃÅ¿Ú»ú£¬2-¹ÜÀí»ú£¬3-ÊÒÄÚ»ú£¬4-Î§Ç½»ú£¬5-±ðÊûÃÅ¿Ú»ú£¬6-¶þ´ÎÈ·ÈÏ»ú£¬7-8700¿Í»§¶Ë£¬8-4200¿Í»§¶Ë£¬9-APP
        ...
        {
            public byte byUnlockType; //¿ªËø·½Ê½£¬²Î¿¼UNLOCK_TYPE_ENUM
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1; //±£Áô
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byControlSrc; //²Ù×÷·¢ÆðÔ´ÐÅÏ¢£¬Ë¢¿¨¿ªËøÊ±Îª¿¨ºÅ£¬À¶ÑÀ¿ªËøÊ±ÎªÓ©Ê¯µÄAPPÕËºÅ£¬¶þÎ¬Âë¿ªËøÊ±Îª·Ã¿ÍµÄÊÖ»úºÅ£¬ÆäÓàÇé¿öÏÂÎªÉè±¸±àºÅ
            public uint dwPicDataLen; //Í¼Æ¬Êý¾Ý³¤¶È
            public IntPtr pImage; //Í¼Æ¬Ö¸Õë
            public uint dwCardUserID; //³Ö¿¨ÈËID
            public ushort nFloorNumber;//Ë¢¿¨¿ªËøÊ±ÓÐÐ§£¬ÎªÂ¥²ãºÅ
            public ushort wRoomNumber; //²Ù×÷·¢ÆðÔ´¸½¼ÓÐÅÏ¢£¬Ë¢¿¨¿ªËøÊ±ÓÐÐ§£¬Îª·¿¼äºÅ£¬
            public ushort wLockID; //£¨¶ÔÓÚÃÅ¿Ú»ú£¬0-±íÊ¾±¾»ú¿ØÖÆÆ÷ÉÏ½ÓµÄËø¡¢1-±íÊ¾Íâ½Ó¿ØÖÆÆ÷ÉÏ½ÓµÄËø£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = LOCK_NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byLockName; //Ë¢¿¨¿ªËøÊ±ÓÐÐ§£¬ËøÃû³Æ£¬¶ÔÓ¦ÃÅ²ÎÊýÅäÖÃÖÐÃÅÃû³Æ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NET_SDK_EMPLOYEE_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byEmployeeNo; //¹¤ºÅ£¨ÈËÔ±ID£©
        ...
        public struct NET_DVR_NOTICEDATA_RECEIPT_INFO
        {
            ...
            public byte[] byNoticeNumber; //¹«¸æ±àºÅ
        ...
        {
            public byte byAuthResult; //ÈÏÖ¤½á¹û£º0-ÎÞÐ§£¬1-ÈÏÖ¤³É¹¦£¬2-ÈÏÖ¤Ê§°Ü
            public byte byAuthType; //ÈÏÖ¤·½Ê½£º0-ÎÞÐ§£¬1-Ö¸ÎÆ£¬2-ÈËÁ³
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1; //±£Áô
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo; //¿¨ºÅ
            public uint dwPicDataLen; //Í¼Æ¬Êý¾Ý³¤¶È£¨µ±ÈÏÖ¤·½Ê½byAuthTypeÎªÈËÁ³Ê±ÓÐÐ§£©
            public IntPtr pImage; //Í¼Æ¬Ö¸Õë£¨µ±ÈÏÖ¤·½Ê½byAuthTypeÎªÈËÁ³Ê±ÓÐÐ§£©
        ...
        {
            public uint dwSize; //½á¹¹Ìå´óÐ¡
            public NET_DVR_TIME_EX struTime; //Ê±¼ä
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DEV_NUMBER_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byDevNumber; //Éè±¸±àºÅ
            public byte byEventType; //ÊÂ¼þÐÅÏ¢ÀàÐÍ£¬1-¿ªËø¼ÇÂ¼£¬2-¹«¸æÐÅÏ¢ÔÄ¶Á»ØÖ´£¬3-ÈÏÖ¤¼ÇÂ¼£¬4-³µÅÆÐÅÏ¢ÉÏ´«£¬5·Ç·¨¿¨Ë¢¿¨ÊÂ¼þ£¬6-ÃÅ¿Ú»ú·¢¿¨¼ÇÂ¼(ÐèÒªÆô¶¯ÃÅ¿Ú»ú·¢¿¨¹¦ÄÜ£¬Ë¢¿¨Ê±²Å»áÉÏ´«¸ÃÊÂ¼þ)
            public byte byPicTransType;        //Í¼Æ¬Êý¾Ý´«Êä·½Ê½: 0-¶þ½øÖÆ£»1-url
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1; //±£Áô
            public NET_DVR_VIDEO_INTERCOM_EVENT_INFO_UINON uEventInfo; //ÊÂ¼þÐÅÏ¢£¬¾ßÌåÄÚÈÝ²Î¿¼byEventTypeÈ¡Öµ
            public uint dwIOTChannelNo;    //IOTÍ¨µÀºÅ
        ...
        {
            public uint dwSize;//½á¹¹Ìå´óÐ¡ 
            public IntPtr lpRequestUrl;//ÇëÇóÐÅÁî£¬×Ö·û´®¸ñÊ½ 
            public uint dwRequestUrlLen;
            public IntPtr lpInBuffer;//ÊäÈë²ÎÊý»º³åÇø£¬XML¸ñÊ½ 
            public uint dwInBufferSize;
            public uint dwRecvTimeOut;//½ÓÊÕ³¬Ê±Ê±¼ä£¬µ¥Î»£ºms£¬Ìî0ÔòÊ¹ÓÃÄ¬ÈÏ³¬Ê±5s 
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public uint dwSize;//½á¹¹Ìå´óÐ¡ 
            public IntPtr lpOutBuffer;//Êä³ö²ÎÊý»º³åÇø£¬XML¸ñÊ½ 
            public uint dwOutBufferSize;
            public uint dwReturnedXMLSize;//Êµ¼ÊÊä³öµÄXMLÄÚÈÝ´óÐ¡ 
            public IntPtr lpStatusBuffer;//·µ»ØµÄ×´Ì¬²ÎÊý(XML¸ñÊ½£ºResponseStatus)£¬»ñÈ¡ÃüÁî³É¹¦Ê±²»»á¸³Öµ£¬Èç¹û²»ÐèÒª£¬¿ÉÒÔÖÃNULL 
            public uint dwStatusSize;//×´Ì¬»º³åÇø´óÐ¡(ÄÚ´æ´óÐ¡) 
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        public struct NET_DVR_CHANNEL_GROUP
        {
            public uint dwSize;//½á¹¹Ìå´óÐ¡ 
            public uint dwChannel;//Í¨µÀºÅ 
            public uint dwGroup; //×éºÅ£¬´Ó0¿ªÊ¼£¬¼´0±íÊ¾µÚ1×é£¬1±íÊ¾µÚ2×é£¬ÒÀ´ÎÀàÍÆ 
            public byte byID;//Éè±¸ÇøÓòÉèÖÃID 
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            public uint dwPositionNo;//³¡¾°Î»ÖÃË÷ÒýºÅ£¬IPCÎª0£¬IPD´Ó1¿ªÊ¼  
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 56, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public uint dwSize;//½á¹¹Ìå´óÐ¡ 
            public byte byEnable;//Ê¹ÄÜÔ½½çÕì²â¹¦ÄÜ£º0- ·ñ£¬1- ÊÇ  
            public byte byEnableDualVca; //ÆôÓÃÖ§³ÖÖÇÄÜºó¼ìË÷£º0- ²»ÆôÓÃ£¬1- ÆôÓÃ 
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;

            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_ALERTLINE_NUM, ArraySubType = UnmanagedType.Struct)]
            public NET_VCA_TRAVERSE_PLANE[] struAlertParam;//¾¯½äÏß²ÎÊý

            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DAYS * MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
            public NET_DVR_SCHEDTIME[] struAlarmSched;//²¼·ÀÊ±¼ä£¬Ã¿ÖÜ7Ìì£¬Ã¿Ìì×î¶àÉèÖÃ8¸öÊ±¼ä¶Î 
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_TIMESEGMENT_V30, ArraySubType = UnmanagedType.Struct)]
            public NET_DVR_SCHEDTIME[] struHolidayTime; //¼ÙÈÕ²¼·ÀÊ±¼ä£¬×î¶àÉèÖÃ8¸öÊ±¼ä¶Î 
        ...
        {
            public uint dwSize;
            public ushort wDistance;//¾àÀë(m)[0, 10000]
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1; //±£Áô
            public float fEmissivity;//·¢ÉäÂÊ(·¢ÉäÂÊ ¾«È·µ½Ð¡ÊýµãºóÁ½Î»)[0.01, 1.00](¼´£ºÎïÌåÏòÍâ·øÉäÄÜÁ¿µÄ±¾Áì)
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 64, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes; //±£Áô
        }
        ...
        {
            public float fPointTemperature;/*µã²âÎÂµ±Ç°ÎÂ¶È, µ±±ê¶¨Îª0-µãÊ±ÉúÐ§¡£¾«È·µ½Ð¡ÊýµãºóÒ»Î»(-40-1000),£¨¸¡µãÊý+100£©*10 */
            public NET_VCA_POINT struPoint;//µã²âÎÂ×ø±ê£¨µ±¹æÔò±ê¶¨ÀàÐÍÎª¡°µã¡±µÄÊ±ºòÉúÐ§£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public float fMaxTemperature;//×î¸ßÎÂ¶È,¾«È·µ½Ð¡ÊýµãºóÒ»Î»(-40-1000),£¨¸¡µãÊý+100£©*10 */
            public float fMinTemperature;//×îµÍÎÂ¶È,¾«È·µ½Ð¡ÊýµãºóÒ»Î»(-40-1000),£¨¸¡µãÊý+100£©*10 */
            public float fAverageTemperature;//Æ½¾ùÎÂ¶È,¾«È·µ½Ð¡ÊýµãºóÒ»Î»(-40-1000),£¨¸¡µãÊý+100£©*10 */
            public float fTemperatureDiff;//ÎÂ²î,¾«È·µ½Ð¡ÊýµãºóÒ»Î»(-40-1000),£¨¸¡µãÊý+100£©*10 */
            public NET_VCA_POLYGON struRegion;//ÇøÓò¡¢Ïß£¨µ±¹æÔò±ê¶¨ÀàÐÍÎª¡°¿ò¡±»òÕß¡°Ïß¡±µÄÊ±ºòÉúÐ§£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public byte byRuleID;//¹æÔòID 0-±íÊ¾ÎÞÐ§£¬´Ó1¿ªÊ¼ £¨listÄÚ²¿ÅÐ¶ÏÊý¾ÝÓÐÐ§ÐÔ£©
            public byte byEnable;//ÊÇ·ñÆôÓÃ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] szRuleName;//¹æÔòÃû³Æ
            public byte byRuleCalibType;//¹æÔò±ê¶¨ÀàÐÍ 0-µã£¬1-¿ò£¬2-Ïß
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
            public NET_SDK_POINT_THERMOMETRY struPointTherm;//µã²âÎÂ£¬µ±±ê¶¨Îª0-µãÊ±ÉúÐ§
            public NET_SDK_REGION_THERMOMETRY struRegionTherm; //ÇøÓò²âÎÂ£¬µ±±ê¶¨Îª1-¿ò¡¢2-ÏßÊ±ÉúÐ§¡£
        ...
        public struct NET_SDK_MANUAL_THERMOMETRY
        {
            public uint dwSize;//½á¹¹Ìå´óÐ¡
            public uint dwChannel;//Í¨µÀºÅ
            public uint dwRelativeTime; // Ïà¶ÔÊ±±ê£¨Ö»¶Á£©
            public uint dwAbsTime;      // ¾ø¶ÔÊ±±ê£¨Ö»¶Á£©
            public byte byThermometryUnit;//²âÎÂµ¥Î»: 0-ÉãÊÏ¶È£¨¡æ£©£¬1-»ªÊÏ¶È£¨¨H£©£¬2-¿ª¶ûÎÄ(K)
            public byte byDataType;//Êý¾Ý×´Ì¬ÀàÐÍ:0-¼ì²âÖÐ£¬1-¿ªÊ¼£¬2-½áÊø£¨Ö»¶Á£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 6, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
        ...
        public struct NET_DVR_FIND_PICTURE_PARAM
        {
            ...
            public byte byProvince;     //Ê¡·ÝË÷ÒýÖµ
            public byte byEventType;      // ÊÂ¼þÀàÐÍ£º0±£Áô£¬1-½»Í¨ÊÂ¼þ£»2-Î¥ÕÂÈ¡Ö¤£»3-ÆäËûÊÂ¼þ
            ...
            //ITC3.7 ÐÂÔö
            public uint dwTrafficType; //Í¼Æ¬¼ìË÷ÉúÐ§Ïî ²Î¿¼ VCA_OPERATE _TYPE 
            public uint dwVehicleType; //³µÁ¾ÀàÐÍ ²Î¿¼ VCA_VEHICLE_TYPE
            //Î¥¹æ¼ì²âÀàÐÍ²Î¿¼ VCA_ILLEGAL_TYPE µ±Ç°²»Ö§³Ö¸´Ñ¡
            public uint dwIllegalType;
            public byte byLaneNo;  //³µµÀºÅ(1~99)
            public byte bySubHvtType;//0-±£Áô,1-»ú¶¯³µ(»ú¶¯³µ×ÓÀàÐÍÖÐÖ§³Ö³µÅÆ¼ìË÷£¬Ê¡·Ý¼ìË÷),2-·Ç»ú¶¯³µ,3-ÐÐÈË
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LICENSE_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] sLicense;    //³µÅÆºÅÂë
            public byte byRegion;     // ÇøÓòË÷ÒýÖµ 0-±£Áô£¬1-Å·ÖÞ(Europe Region)£¬2-¶íÓïÇøÓò(Russian Region)£¬3-Å·ÖÞ&¶íÂÞË¹(EU&CIS), 4-ÖÐ¶«(Middle East),0xff-ËùÓÐ
            public byte byCountry;     // ¹ú¼ÒË÷ÒýÖµ£¬²ÎÕÕ£ºCOUNTRY_INDEX 
            public byte byArea;  //µØÇø
            public byte byISO8601;  //ÊÇ·ñÊÇ8601µÄÊ±¼ä¸ñÊ½£¬¼´Ê±²î×Ö¶ÎÊÇ·ñÓÐÐ§0-Ê±²îÎÞÐ§£¬ÄêÔÂÈÕÊ±·ÖÃëÎªÉè±¸±¾µØÊ±¼ä 1-Ê±²îÓÐÐ§ 
            public byte cStartTimeDifferenceH;   //¿ªÊ¼Ê±¼äÓëUTCµÄÊ±²î£¨Ð¡Ê±£©£¬-12 ... +14£¬ ÕýÊý±íÊ¾¶«Ê±Çø
            public byte cStartTimeDifferenceM;   //¿ªÊ¼Ê±¼äÓëUTCµÄÊ±²î£¨·ÖÖÓ£©£¬-30, 0, 30, 45£¬ÕýÊý±íÊ¾¶«Ê±Çø
            public byte cStopTimeDifferenceH;    //½áÊøÊ±¼äÓëUTCµÄÊ±²î£¨Ð¡Ê±£©£¬-12 ... +14£¬ÕýÊý±íÊ¾¶«Ê±Çø
            public byte cStopTimeDifferenceM;    //½áÊøÊ±¼äÓëUTCµÄÊ±²î£¨·ÖÖÓ£©£¬-30, 0, 30, 45£¬ÕýÊý±íÊ¾¶«Ê±Çø
        }
        ...
        public struct NET_VCA_HUMAN_FEATURE
        {
            ...
            public byte bySex;         //ÐÔ±ð, 0-±íÊ¾¡°Î´Öª¡±£¨Ëã·¨²»Ö§³Ö£©,1 ¨C ÄÐ , 2 ¨C Å®, 0xff-Ëã·¨Ö§³Ö£¬µ«ÊÇÃ»ÓÐÊ¶±ð³öÀ´
            public byte byEyeGlass;    //ÊÇ·ñ´÷ÑÛ¾µ 0-±íÊ¾¡°Î´Öª¡±£¨Ëã·¨²»Ö§³Ö£©,1 ¨C ²»´÷, 2 ¨C ´÷,0xff-Ëã·¨Ö§³Ö£¬µ«ÊÇÃ»ÓÐÊ¶±ð³öÀ´
            //×¥ÅÄÍ¼Æ¬ÈËÁ³ÄêÁäµÄÊ¹ÓÃ·½Ê½£¬ÈçbyAgeÎª15,byAgeDeviationÎª1,±íÊ¾£¬Êµ¼ÊÈËÁ³Í¼Æ¬ÄêÁäµÄÎª14-16Ö®¼ä
            public byte byAge;//ÄêÁä 0-±íÊ¾¡°Î´Öª¡±£¨Ëã·¨²»Ö§³Ö£©,0xff-Ëã·¨Ö§³Ö£¬µ«ÊÇÃ»ÓÐÊ¶±ð³öÀ´
            public byte byAgeDeviation;//ÄêÁäÎó²îÖµ
            public byte byEthnic;   //×Ö¶ÎÔ¤Áô,ÔÝ²»¿ª·Å
            public byte byMask;       //ÊÇ·ñ´÷¿ÚÕÖ 0-±íÊ¾¡°Î´Öª¡±£¨Ëã·¨²»Ö§³Ö£©,1 ¨C ²»´÷, 2 ¨C´÷ÆÕÍ¨ÑÛ¾µ, 3 ¨C´÷Ä«¾µ,0xff-Ëã·¨Ö§³Ö£¬µ«ÊÇÃ»ÓÐÊ¶±ð³öÀ´
            public byte bySmile;      //ÊÇ·ñÎ¢Ð¦ 0-±íÊ¾¡°Î´Öª¡±£¨Ëã·¨²»Ö§³Ö£©,1 ¨C ²»Î¢Ð¦, 2 ¨C Î¢Ð¦, 0xff-Ëã·¨Ö§³Ö£¬µ«ÊÇÃ»ÓÐÊ¶±ð³öÀ´
            public byte byFaceExpression;    /*±íÇé,²Î¼ûFACE_EXPRESSION_GROUP_ENUM*/
            public byte byBeard;  //ºú×Ó, 0-²»Ö§³Ö£¬1-Ã»ÓÐºú×Ó£¬2-ÓÐºú×Ó£¬0xff-unknow±íÊ¾Î´Öª,Ëã·¨Ö§³ÖÎ´¼ì³ö
            public byte byRace;  //ÈËÖÖ, 0-²»Ö§³Ö£¬1-ÑÇÖÞÈË£¬2-ºÚÈË£¬3-°×ÈË,0xff-unknow±íÊ¾Î´Öª,Ëã·¨Ö§³ÖÎ´¼ì³ö
            public byte byHat;   //Ã±×Ó, 0-²»Ö§³Ö,1-²»´÷Ã±×Ó,2-´÷Ã±×Ó,0xff-unknow±íÊ¾Î´Öª,Ëã·¨Ö§³ÖÎ´¼ì³ö
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes; //±£Áô
        }
        ...
        public struct NET_VCA_HUMAN_ATTRIBUTE
        {
            ...
            public byte byAgeGroup;//ÄêÁä¶Î£¬Ïê¼ûHUMAN_AGE_GROUP_ENUM£¬Èç´«Èë0xff±íÊ¾Î´Öª
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 11, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;//±£Áô
        }
        ...
        public struct NET_VCA_BLOCKLIST_INFO
        {
            ...
            public uint dwFCAdditionInfoLen;//×¥ÅÄ¿â¸½¼ÓÐÅÏ¢³¤¶È
            public IntPtr pFCAdditionInfoBuffer;//×¥ÅÄ¿â¸½¼ÓÐÅÏ¢Êý¾ÝÖ¸Õë£¨FCAdditionInfoÖÐ°üº¬Ïà»úPTZ×ø±ê£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;//±£Áô
        }
        ...
        public struct NET_VCA_BLOCKLIST_PIC
        {
            ...
            public byte[] byRes; //±£Áô
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_HUMAN_PICTURE_NUM, ArraySubType = UnmanagedType.Struct)]
            public NET_VCA_PICMODEL_RESULT[] struBlockListPic;  //µ¥ÕÅÕÕÆ¬ÐÅÏ¢
        }
        ...
        public struct NET_VCA_FACESNAP_INFO_ALARM
        {
            ...
            public byte byAgeDeviation;//ÄêÁäÎó²îÖµ
            public byte byAgeGroup;//ÄêÁä¶Î£¬Ïê¼ûHUMAN_AGE_GROUP_ENUM£¬Èô´«Èë0xff±íÊ¾Î´Öª
            /*ÈËÁ³×ÓÍ¼Í¼Æ¬ÖÊÁ¿ÆÀ¹ÀµÈ¼¶£¬0-µÍµÈÖÊÁ¿,1-ÖÐµÈÖÊÁ¿,2-¸ßµÈÖÊÁ¿,
            ¸ÃÖÊÁ¿ÆÀ¹ÀËã·¨½öÕë¶ÔÈËÁ³×ÓÍ¼µ¥ÕÅÍ¼Æ¬,¾ßÌåÊÇÍ¨¹ý×ËÌ¬¡¢ÇåÎú¶È¡¢ÕÚµ²Çé¿ö¡¢¹âÕÕÇé¿öµÈ¿ÉÓ°ÏìÈËÁ³Ê¶±ðÐÔÄÜµÄÒòËØ×ÛºÏÆÀ¹ÀµÄ½á¹û*/
            public byte byFacePicQuality;
            public byte byEthnic; //×Ö¶ÎÔ¤Áô,ÔÝ²»¿ª·Å
        ...
        public struct NET_VCA_BLOCKLIST_INFO_ALARM
        {
            ...
            public uint dwBlockListPicLen;       //ºÚÃûµ¥ÈËÁ³×ÓÍ¼µÄ³¤¶È£¬Îª0±íÊ¾Ã»ÓÐÍ¼Æ¬£¬´óÓÚ0±íÊ¾ÓÐÍ¼Æ¬
        ...
        public struct NET_VCA_FACESNAP_MATCH_ALARM
        {
            ...
            public NET_VCA_BLOCKLIST_INFO_ALARM struBlockListInfo; //ºÚÃûµ¥ÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 16, ArraySubType = UnmanagedType.I1)]
            public byte[] sStorageIP;        //´æ´¢·þÎñIPµØÖ·
            public ushort wStoragePort;            //´æ´¢·þÎñ¶Ë¿ÚºÅ
            ...
            public byte byModelingStatus;// ½¨Ä£×´Ì¬
            public byte byLivenessDetectionStatus;//»îÌå¼ì²â×´Ì¬£º0-±£Áô£¬1-Î´Öª£¨¼ì²âÊ§°Ü£©£¬2-·ÇÕæÈËÈËÁ³£¬3-ÕæÈËÈËÁ³£¬4-Î´¿ªÆô»îÌå¼ì²â
            public byte cTimeDifferenceH;         /*ÓëUTCµÄÊ±²î£¨Ð¡Ê±£©£¬-12 ... +14£¬ +±íÊ¾¶«Çø,0xffÎÞÐ§*/
            public byte cTimeDifferenceM;       /*ÓëUTCµÄÊ±²î£¨·ÖÖÓ£©£¬-30, 30, 45£¬ +±íÊ¾¶«Çø£¬0xffÎÞÐ§*/
            public byte byMask;                //×¥ÅÄÍ¼ÊÇ·ñ´÷¿ÚÕÖ£¬0-±£Áô£¬1-Î´Öª£¬2-²»´÷¿ÚÕÖ£¬3-´÷¿ÚÕÖ
            public byte bySmile;               //×¥ÅÄÍ¼ÊÇ·ñÎ¢Ð¦£¬0-±£Áô£¬1-Î´Öª£¬2-²»Î¢Ð¦£¬3-Î¢Ð¦
            public byte byContrastStatus;      //±È¶Ô½á¹û£¬0-±£Áô£¬1-±È¶Ô³É¹¦£¬2-±È¶ÔÊ§°Ü
            public byte byBrokenNetHttp;     //¶ÏÍøÐø´«±êÖ¾Î»£¬0-²»ÊÇÖØ´«Êý¾Ý£¬1-ÖØ´«Êý¾Ý
        }
        ...
        public struct NET_VCA_FACESNAP_MATCH_ALARM_LOG
        {
            ...
            public NET_VCA_BLOCKLIST_INFO_ALARM_LOG struBlockListInfoLog; //ºÚÃûµ¥ÐÅÏ¢
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 60, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              // ±£Áô×Ö½Ú
        }
        ...
        public struct NET_VCA_FACEMATCH_PICCOND
        {
            ...
            public uint dwBlockListID; //Æ¥ÅäµÄºÚÃûµ¥ID
            public uint dwBlockListFaceID; //±È¶ÔµÄºÚÃûµ¥ÈËÁ³×ÓÍ¼ID
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              // ±£Áô×Ö½Ú
        }
        ...
        public struct NET_VCA_FACEMATCH_PICTURE
        {
            ...
            public uint dwBlockListFaceLen; //±È¶ÔµÄºÚÃûµ¥ÈËÁ³×ÓÍ¼³¤¶È
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 20, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;              //±£Áô×Ö½Ú
            public IntPtr pSnapFace;  //×¥ÅÄÈËÁ³×ÓÍ¼µÄÍ¼Æ¬Êý¾Ý
            public IntPtr pBlockListFace;  //±È¶ÔµÄºÚÃûµ¥ÈËÁ³×ÓÍ¼Êý¾Ý
        }
        ...
        {
            public uint dwSize;   //½á¹¹´óÐ¡
            public NET_VCA_BLOCKLIST_INFO struBlockListInfo;  //ºÚÃûµ¥»ù±¾²ÎÊý
        ...
        {
            public ushort wMajorType;            //0-ÒÆ¶¯Õì²â£¬1-±¨¾¯ÊäÈë, 2-ÖÇÄÜÊÂ¼þ 5-posÂ¼Ïñ 7-ÃÅ½ûÊÂ¼þ
            public ushort wMinorType;            //ËÑË÷´ÎÀàÐÍ- ¸ù¾ÝÖ÷ÀàÐÍ±ä»¯£¬0xffff±íÊ¾È«²¿
            public NET_DVR_TIME struStartTime;    //ËÑË÷µÄ¿ªÊ¼Ê±¼ä£¬Í£Ö¹Ê±¼ä: Í¬Ê±Îª(0, 0) ±íÊ¾´Ó×îÔçµÄÊ±¼ä¿ªÊ¼£¬µ½×îºó£¬×îÇ°ÃæµÄ4000¸öÊÂ¼þ
            public NET_DVR_TIME struEndTime;    //
            public byte byLockType;        // 0xff-È«²¿£¬0-Î´Ëø£¬1-Ëø¶¨
            public byte byQuickSearch;        // ÊÇ·ñÆôÓÃ¿ìËÙ²éÑ¯£¬0-²»ÆôÓÃ£¬1-ÆôÓÃ£¨¿ìËÙ²éÑ¯²»»á·µ»ØÎÄ¼þ´óÐ¡£¬½ö¶ÔÉè±¸Êý¾Ý¿â½øÐÐ²éÑ¯£¬±ÜÃâÆµ·±»½ÐÑÓ²ÅÌ£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 130, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;// ±£Áô
        ...
        public struct NET_DVR_SEARCH_EVENT_RET_V40
        {
            ...
            public ushort[] wChan;    //´¥·¢µÄÍ¨µÀºÅ£¬0xffff±íÊ¾ºóÐøÎÞÐ§
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 36, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        ...
        public const int NET_SDK_MAX_TAPE_INDEX_LEN = 32; //´Å´ø±àºÅ×î´ó³¤¶È
        public const int NET_SDK_MAX_FILE_LEN = 256;      //ÎÄ¼þÃû×î´ó³¤¶È
        ...
        public struct NET_DVR_PREVIEWINFO
        {
            ...
            public byte byRes1;
            public byte byVideoCodingType; //ÂëÁ÷Êý¾Ý±à½âÂëÀàÐÍ 0-Í¨ÓÃ±àÂëÊý¾Ý 1-ÈÈ³ÉÏñÌ½²âÆ÷²úÉúµÄÔ­Ê¼Êý¾Ý£¨ÎÂ¶ÈÊý¾ÝµÄ¼ÓÃÜÐÅÏ¢£¬Í¨¹ýÈ¥¼ÓÃÜÔËËã£¬½«Ô­Ê¼Êý¾ÝËã³öÕæÊµµÄÎÂ¶ÈÖµ£©
            public uint dwDisplayBufNum; //²¥·Å¿â²¥·Å»º³åÇø×î´ó»º³åÖ¡Êý£¬·¶Î§1-50£¬ÖÃ0Ê±Ä¬ÈÏÎª1 
            public byte byNPQMode;	//NPQÊÇÖ±Á¬Ä£Ê½£¬»¹ÊÇ¹ýÁ÷Ã½Ìå 0-Ö±Á¬ 1-¹ýÁ÷Ã½Ìå
        ...
        {
            public byte byEnable; //Ê¹ÄÜÓÐÐ§ÆÚ£¬0-²»Ê¹ÄÜ£¬1Ê¹ÄÜ
            public byte byBeginTimeFlag;      //ÊÇ·ñÏÞÖÆÆðÊ¼Ê±¼äµÄ±êÖ¾£¬0-²»ÏÞÖÆ£¬1-ÏÞÖÆ
            public byte byEnableTimeFlag;     //ÊÇ·ñÏÞÖÆÖÕÖ¹Ê±¼äµÄ±êÖ¾£¬0-²»ÏÞÖÆ£¬1-ÏÞÖÆ
            public byte byTimeDurationNo;     //ÓÐÐ§ÆÚË÷Òý,´Ó0¿ªÊ¼£¨Ê±¼ä¶ÎÍ¨¹ýSDKÉèÖÃ¸øËø£¬ºóÐøÔÚÖÆ¿¨Ê±£¬Ö»ÐèÒª´«µÝÓÐÐ§ÆÚË÷Òý¼´¿É£¬ÒÔ¼õÉÙÊý¾ÝÁ¿£©
            public NET_DVR_TIME_EX struBeginTime; //ÓÐÐ§ÆÚÆðÊ¼Ê±¼ä
            public NET_DVR_TIME_EX struEndTime; //ÓÐÐ§ÆÚ½áÊøÊ±¼ä
            public byte byTimeType; //Ê±¼äÀàÐÍ£º0-Éè±¸±¾µØÊ±¼ä£¨Ä¬ÈÏ£©£¬1-UTCÊ±¼ä£¨¶ÔÓÚstruBeginTime£¬struEndTime×Ö¶ÎÓÐÐ§£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 31, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
        }
        ...
        public struct NET_DVR_CARD_CFG_V50
        {
            ...
            // #define CARD_PARAM_EMPLOYEE_NO      0x00000400  //¹¤ºÅ
            // #define CARD_PARAM_NAME             0x00000800  //ÐÕÃû
            // #define CARD_PARAM_DEPARTMENT_NO    0x00001000  //²¿ÃÅ±àºÅ
            // #define CARD_SCHEDULE_PLAN_NO       0x00002000  //ÅÅ°à¼Æ»®±àºÅ
            // #define CARD_SCHEDULE_PLAN_TYPE     0x00004000  //ÅÅ°à¼Æ»®ÀàÐÍ
            // #define CARD_ROOM_NUMBER            0x00008000  //·¿¼äºÅ
            // #define CARD_SIM_NO                 0x00010000  //SIM¿¨ºÅ£¨ÊÖ»úºÅ£©
            // #define CARD_FLOOR_NUMBER           0x00020000  //Â¥²ãºÅ
            // #define CARD_USER_TYPE              0x00040000  //ÓÃ»§ÀàÐÍ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = ACS_CARD_NO_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardNo; //¿¨ºÅ
            public byte byCardValid; //¿¨ÊÇ·ñÓÐÐ§£¬0-ÎÞÐ§£¬1-ÓÐÐ§£¨ÓÃÓÚÉ¾³ý¿¨£¬ÉèÖÃÊ±ÖÃÎª0½øÐÐÉ¾³ý£¬»ñÈ¡Ê±´Ë×Ö¶ÎÊ¼ÖÕÎª1£©
            public byte byCardType; //¿¨ÀàÐÍ£¬1-ÆÕÍ¨¿¨£¬2-²Ð¼²ÈË¿¨£¬3-ºÚÃûµ¥¿¨£¬4-Ñ²¸ü¿¨£¬5-Ð²ÆÈ¿¨£¬6-³¬¼¶¿¨£¬7-À´±ö¿¨£¬8-½â³ý¿¨£¬9-Ô±¹¤¿¨£¬10-Ó¦¼±¿¨£¬11-Ó¦¼±¹ÜÀí¿¨£¨ÓÃÓÚÊÚÈ¨ÁÙÊ±¿¨È¨ÏÞ£¬±¾Éí²»ÄÜ¿ªÃÅ£©£¬Ä¬ÈÏÆÕÍ¨¿¨
            public byte byLeaderCard; //ÊÇ·ñÎªÊ×¿¨£¬1-ÊÇ£¬0-·ñ
            public byte byUserType; // 0 ¨C ÆÕÍ¨ÓÃ»§1 - ¹ÜÀíÔ±ÓÃ»§;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DOOR_NUM_256, ArraySubType = UnmanagedType.I1)]
            public byte[] byDoorRight; //ÃÅÈ¨ÏÞ(Â¥²ãÈ¨ÏÞ¡¢ËøÈ¨ÏÞ)£¬°´Î»±íÊ¾£¬1ÎªÓÐÈ¨ÏÞ£¬0ÎªÎÞÈ¨ÏÞ£¬´ÓµÍÎ»µ½¸ßÎ»±íÊ¾¶ÔÃÅ£¨Ëø£©1-NÊÇ·ñÓÐÈ¨ÏÞ
            public NET_DVR_VALID_PERIOD_CFG struValid; //ÓÐÐ§ÆÚ²ÎÊý
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_GROUP_NUM_128, ArraySubType = UnmanagedType.I1)]
            public byte[] byBelongGroup; //ËùÊôÈº×é£¬°´×Ö½Ú±íÊ¾£¬1-ÊôÓÚ£¬0-²»ÊôÓÚ
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = CARD_PASSWORD_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byCardPassword; //¿¨ÃÜÂë
            ...
            public ushort[] wCardRightPlan; //¿¨È¨ÏÞ¼Æ»®£¬È¡ÖµÎª¼Æ»®Ä£°å±àºÅ£¬Í¬¸öÃÅ£¨Ëø£©²»Í¬¼Æ»®Ä£°å²ÉÓÃÈ¨ÏÞ»òµÄ·½Ê½´¦Àí
            public uint dwMaxSwipeTime; //×î´óË¢¿¨´ÎÊý£¬0ÎªÎÞ´ÎÊýÏÞÖÆ£¨¿ªËø´ÎÊý£©
            public uint dwSwipeTime; //ÒÑË¢¿¨´ÎÊý
            public ushort wRoomNumber;  //·¿¼äºÅ
            public ushort wFloorNumber;   //²ãºÅ
            public uint dwEmployeeNo;   //¹¤ºÅ£¨ÓÃ»§ID£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byName;   //ÐÕÃû
            public ushort wDepartmentNo;   //²¿ÃÅ±àºÅ
            public ushort wSchedulePlanNo;   //ÅÅ°à¼Æ»®±àºÅ
            public byte bySchedulePlanType;  //ÅÅ°à¼Æ»®ÀàÐÍ£º0-ÎÞÒâÒå¡¢1-¸öÈË¡¢2-²¿ÃÅ
            public byte byRightType;  //ÏÂ·¢È¨ÏÞÀàÐÍ£º0-ÆÕÍ¨·¢¿¨È¨ÏÞ¡¢1-¶þÎ¬ÂëÈ¨ÏÞ¡¢2-À¶ÑÀÈ¨ÏÞ£¨¿ÉÊÓ¶Ô½²Éè±¸¶þÎ¬ÂëÈ¨ÏÞÅäÖÃÏî£º·¿¼äºÅ¡¢¿¨ºÅ£¨ÐéÄâ¿¨ºÅ£©¡¢×î´óË¢¿¨´ÎÊý£¨¿ªËø´ÎÊý£©¡¢ÓÐÐ§ÆÚ²ÎÊý£»À¶ÑÀÈ¨ÏÞ£º¿¨ºÅ£¨Ó©Ê¯APPÕËºÅ£©¡¢ÆäËû²ÎÊýÅäÖÃÓëÆÕÍ¨·¢¿¨È¨ÏÞÒ»ÖÂ£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes2;
            public uint dwLockID;  //ËøID
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_LOCK_CODE_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byLockCode;    //Ëø´úÂë
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = MAX_DOOR_CODE_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] byRoomCode;  //·¿¼ä´úÂë
            //°´Î»±íÊ¾£¬0-ÎÞÈ¨ÏÞ£¬1-ÓÐÈ¨ÏÞ
            //µÚ0Î»±íÊ¾£ºÈõµç±¨¾¯
            //µÚ1Î»±íÊ¾£º¿ªÃÅÌáÊ¾Òô
            //µÚ2Î»±íÊ¾£ºÏÞÖÆ¿Í¿¨
            //µÚ3Î»±íÊ¾£ºÍ¨µÀ
            //µÚ4Î»±íÊ¾£º·´Ëø¿ªÃÅ
            //µÚ5Î»±íÊ¾£ºÑ²¸ü¹¦ÄÜ
            public uint dwCardRight;      //¿¨È¨ÏÞ
            public uint dwPlanTemplate;   //¼Æ»®Ä£°å(Ã¿Ìì)¸÷Ê±¼ä¶ÎÊÇ·ñÆôÓÃ£¬°´Î»±íÊ¾£¬0--²»ÆôÓÃ£¬1-ÆôÓÃ
            public uint dwCardUserId;    //³Ö¿¨ÈËID
            public byte byCardModelType;  //0-¿Õ£¬1- MIFARE S50£¬2- MIFARE S70£¬3- FM1208 CPU¿¨£¬4- FM1216 CPU¿¨£¬5-¹úÃÜCPU¿¨£¬6-Éí·ÝÖ¤£¬7- NFC
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 51, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes3;
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = NAME_LEN, ArraySubType = UnmanagedType.I1)]
            public byte[] bySIMNum; //SIM¿¨ºÅ£¨ÊÖ»úºÅ£©
        }
        ...
        {
            public uint dwSize;
            public uint dwPictureNum; //Í¼Æ¬ÊýÁ¿
            public byte byCheckTemplate; //0-Ð£ÑéÍ¼Æ¬ÊÇ·ñºÏ·¨£¨Ä¬ÈÏ£©£¬1-Ð£ÑéÍ¼Æ¬ºÍ½¨Ä£Êý¾ÝÊÇ·ñÆ¥Åä
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 127, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public byte byExceptionCbDirectly;    //0-Í¨¹ýÏß³Ì³ØÒì³£»Øµ÷£¬1-Ö±½ÓÒì³£»Øµ÷¸øÉÏ²ã
            public byte byNotSplitRecordFile;     //»Ø·ÅºÍÔ¤ÀÀÖÐ±£´æµ½±¾µØÂ¼ÏñÎÄ¼þ²»ÇÐÆ¬ 0-Ä¬ÈÏÇÐÆ¬£¬1-²»ÇÐÆ¬
            public byte byResumeUpgradeEnable;    //¶ÏÍøÐø´«Éý¼¶Ê¹ÄÜ£¬0-¹Ø±Õ£¨Ä¬ÈÏ£©£¬1-¿ªÆô
            public byte byAlarmJsonPictureSeparate;   //¿ØÖÆJSONÍ¸´«±¨¾¯Êý¾ÝºÍÍ¼Æ¬ÊÇ·ñ·ÖÀë£¬0-²»·ÖÀë£¬1-·ÖÀë£¨·ÖÀëºó×ßCOMM_ISAPI_ALARM»Øµ÷·µ»Ø£©
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 4, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;      //±£Áô
            public Int64 i64FileSize;      //µ¥Î»£ºByte
            public uint dwResumeUpgradeTimeout;       //¶ÏÍøÐø´«ÖØÁ¬³¬Ê±Ê±¼ä£¬µ¥Î»ºÁÃë
        ...
        {
            public uint dwCheckOnlineTimeout;     //Ñ²¼ìÊ±¼ä¼ä¸ô£¬µ¥Î»ms  ×îÐ¡ÖµÎª30s£¬×î´óÖµ120s¡£Îª0Ê±£¬±íÊ¾ÓÃÄ¬ÈÏÖµ(120s)
            public uint dwCheckOnlineNetFailMax;  //ÓÉÓÚÍøÂçÔ­ÒòÊ§°ÜµÄ×î´óÀÛ¼Ó´ÎÊý£»³¬¹ý¸ÃÖµSDK²Å»Øµ÷ÓÃ»§Òì³££¬Îª0Ê±£¬±íÊ¾Ê¹ÓÃÄ¬ÈÏÖµ1
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 256, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        {
            public IntPtr pAlarmData;           // ±¨¾¯Êý¾Ý
            public uint dwAlarmDataLen;   // ±¨¾¯Êý¾Ý³¤¶È
            public byte byDataType;        // 0-invalid,1-xml,2-json
            public byte byPicturesNumber;  // Í¼Æ¬ÊýÁ¿
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 2, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
            public IntPtr pPicPackData;         // Í¼Æ¬±ä³¤²¿·Ö
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 32, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
        }
        public const int MAX_FILE_PATH_LEN = 256;     //ÎÄ¼þÂ·¾¶³¤¶È
        [StructLayoutAttribute(LayoutKind.Sequential)]
        public struct NET_DVR_ALARM_ISAPI_PICDATA
        {
            public uint dwPicLen;
            public byte byPicType;  //Í¼Æ¬¸ñÊ½: 1- jpg
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        ...
        {
            public uint dwSize;
            public byte byDevType;    //1-UPS£¬2-¿ª¹ØµçÔ´£¬3-ÆøÌå¼ì²âÏµÍ³£¬4-ÎÂÊª¶È´«¸ÐÆ÷£¬5-¿Õµ÷£¬6-µçÁ¿±í£¬7-±äµçÆ÷×´Ì¬, 8-Ë®Î»´«¸ÐÆ÷¡¢9-Ñï³¾ÔëÉù´«¸ÐÆ÷¡¢10-»·¾³²É¼¯ÒÇ¡¢11-·çËÙ´«¸ÐÆ÷×´Ì¬¡¢12-Í¨ÓÃÀ©Õ¹Êä³öÄ£¿é×´Ì¬¡¢13-½þË®´«¸ÐÆ÷×´Ì¬¡¢14-Ì«ÑôÄÜ¿ØÖÆÆ÷×´Ì¬¡¢15-SF6±¨¾¯Ö÷»ú×´Ì¬¡¢16-³ÆÖØÒÇ×´Ì¬¡¢17-ÆøÏó²É¼¯ÏµÍ³×´Ì¬¡¢18-Ë®ÖÊ¼ì²âÒÇ×´Ì¬¡¢19-È¼Æø¼à²âÏµÍ³×´Ì¬¡¢20-Ïû·ÀÖ÷»ú×´Ì¬
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 3, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes1;
        ...
        public enum NET_SDK_CALLBACK_STATUS_NORMAL
        {
            ...
            NET_SDK_CALLBACK_STATUS_LANGUAGE_MISMATCH,     //ÓïÑÔ²»Æ¥Åä
            NET_SDK_CALLBACK_STATUS_DEV_TYPE_MISMATCH,     //Éè±¸ÀàÐÍ²»Æ¥Åä
